...
export default function GeometricIntro({ onComplete, className }: GeometricIntroProps) {
  ...
  const shapes = [
  { type: "circle", color: "bg-teal-400", size: "w-20 h-20 md:w-28 md:h-28", delay: 0 },
  { type: "square", color: "bg-cyan-500", size: "w-14 h-14 md:w-20 md:h-20", delay: 0.15 },
  { type: "triangle", color: "bg-indigo-600", size: "w-24 h-24 md:w-32 md:h-32", delay: 0.3 },
  { type: "circle", color: "bg-sky-400", size: "w-12 h-12 md:w-18 md:h-18", delay: 0.45 },
  { type: "square", color: "bg-blue-700", size: "w-16 h-16 md:w-22 md:h-22", delay: 0.6 },
]
