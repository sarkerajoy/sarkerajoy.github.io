...
import { Facebook, Linkedin, Github, Mail, MapPin, Instagram, GraduationCap } from "lucide-react"
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <div className="flex space-x-4">
                      {[
                        ...
                        { icon: <Instagram className="h-5 w-5" />, href: "https://www.instagram.com/glubtabis_wepal/", label: "Instargram" },
                        { icon: <Github className="h-5 w-5" />, href: "https://github.com/sarkerajoy", label: "Github" },
