          ...
          {activeTab === "technical" && (
            <>
              ...
              >
                ...
                <p className="text-white/80 mb-1">Team Interplanetar BUET</p>
                <p className="text-white/60 text-sm mb-6">Feb 2021 - Dec 2023</p>

                <div className="space-y-4">
                  <p className="text-white/80">
                    Design & Development of a new suspension system for better modularity
                  </p>
                  <p className="text-white/80">Attended ERC 2022 onsite in Kielce, Poland.</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <p className="text-white/80 mb-1">BAC Skill Development Program</p>
                <p className="text-white/60 text-sm mb-6">June 2021 - Jan 2023</p>

                <div className="space-y-4">
                  <p className="text-white/80">Mentored 200+ students on SolidWorks from beginner to Pro</p>
                  <p className="text-white/80">Judge of BAC Autofest 2024</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <p className="text-white/80 mb-1">Ashuganj Power Station Company Ltd (APSCL)</p>
                <p className="text-white/60 text-sm mb-6">October 2023 - Nov 2023</p>

                <div className="space-y-4">
                  <p className="text-white/80">Assigned Department: Mechanical Maintenance</p>
                </div>
              </motion.div>
            </>
          )}
